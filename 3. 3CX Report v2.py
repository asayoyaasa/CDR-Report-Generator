...
# Group the data by 'Caller ID' and calculate the count of 'Destination', the sum of 'Talking',
# the earliest 'Call Time', and the latest 'Call Time' in each group
grouped_data = df.groupby('Caller ID').agg({
...
grouped_data.to_csv('3cxv2out.csv', index=False)
